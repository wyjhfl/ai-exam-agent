...
**新功能：**
- 新增真题库前端页面：支持真题列表、科目/年份筛选、试卷预览、开始练习、提交判分、成绩报告
- 真题练习支持 5 种题型：单选、多选、判断、填空、简答
- 新增学习数据可视化：正确率趋势折线图、各科刷题量柱状图、各科正确率柱状图、学习活跃热力图
- 检查更新升级为弹窗式提示，支持查看更新日志与跳转下载

**体验优化：**
- 统一 401 登录态失效处理，避免重复 toast
- 后端启动失败页面增强：支持重试连接与重启后端
- 真题库页面组件拆分，提升可维护性
- 新增通用 EmptyState / PageLoader 组件
- 分析页图表支持 dark mode 与响应式布局
